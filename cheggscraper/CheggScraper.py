...
main_template = Environment().from_string(read_text('templates', 'template.html'))
chapter_type_template = Environment().from_string(read_text('templates', 'chapter_type_frame.html'))
